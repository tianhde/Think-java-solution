...
public class Rational{
  ...
  //To reduce the rational(约分） (pure function:no change to the original objects)
 public Rational reduce(){
      int gcd = gcd(numerator,denominator);
      //不需要有一个object来用这个non-static method??
      return new Rational(this.numerator / gcd, this.denominator / gcd); 
      //pure funtion method:可以通过new keyword来创建一个新的Object
   }
